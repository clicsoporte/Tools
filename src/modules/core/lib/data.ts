...
export const permissionTranslations: { [key: string]: string } = {
    ...
    "planner:read": "Plan.: Leer Órdenes", "planner:create": "Plan.: Crear Órdenes",

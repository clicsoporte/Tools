...
export const allAdminPermissions = [
    ...
    "consignments:access", "consignments:setup", "consignments:count", "consignments:boleta:approve", "consignments:boleta:send", "consignments:boleta:invoice", "consignments:boleta:cancel", "consignments:boleta:revert", "consignments:reports:read", "consignments:locks:manage",
...
export const permissionGroups = {
    ...
    "Consignación (Configuración y Conteos)": ["consignments:access", "consignments:setup", "consignments:count", "consignments:reports:read", "consignments:locks:manage"],

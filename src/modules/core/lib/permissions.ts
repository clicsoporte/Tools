...
export const permissionTranslations: { [key: string]: string } = {
    ...
    "warehouse:access": "Almacén: Acceso General", "warehouse:search:full": "Almacén: Consulta Completa", "warehouse:search:simple": "Almacén: Búsqueda Rápida", "warehouse:receiving:create": "Almacén: Usar Asistentes", "warehouse:inventory:assign": "Almacén: Asignar Inventario", "warehouse:locations:manage": "Almacén: Gestionar Ubicaciones", "warehouse:units:manage": "Almacén: Gestionar Lotes/QR", "warehouse:locks:manage": "Almacén: Gestionar Bloqueos",

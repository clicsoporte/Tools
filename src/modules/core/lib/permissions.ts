...
export const permissionGroups = {
    ...
    "Gestión de Almacenes": [
        ...
        "warehouse:correction:execute", "warehouse:correction:apply", "warehouse:labels:generate", "warehouse:cleanup"
    ],
...
export const permissionTranslations = {
    ...
    "warehouse:correction:execute": "Almacén: Corregir Ingreso", "warehouse:correction:apply": "Almacén: Aplicar Ingreso", "warehouse:labels:generate": "Almacén: Generar Etiquetas", "warehouse:cleanup": "Almacén: Herramientas de Limpieza",
...
export const permissionTree: Partial<Record<AppPermission, AppPermission[]>> = {
    ...
    "warehouse:access": [
        ...
        "warehouse:correction:execute", "warehouse:labels:generate", "warehouse:cleanup"
    ],

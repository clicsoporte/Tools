...
export const consignmentsSchema: ExpectedSchema = {
    ...
    'restock_boletas': ['id', 'consecutive', 'agreement_id', 'status', 'created_by', 'submitted_by', 'created_at', 'approved_by', 'approved_at', 'erp_invoice_number', 'notes', 'delivery_date', 'erp_movement_id'],

...
export const warehouseSchema: ExpectedSchema = {
    'locations': ['id', 'name', 'code', 'type', 'parentId', 'isLocked', 'lockedBy', 'lockedBySessionId', 'is_mixed'],
    ...
    'inventory_units': ['id', 'unitCode', 'receptionConsecutive', 'correctionConsecutive', 'correctedFromUnitId', 'productId', 'humanReadableId', 'documentId', 'erpDocumentId', 'locationId', 'quantity', 'notes', 'createdAt', 'createdBy', 'status', 'appliedAt', 'appliedBy', 'annulledAt', 'annulledBy'],

...
export default function PurchaseRequestPage() {
    ...
    const renderRequestCard = (request: PurchaseRequest) => {
        ...
        const changeStatusActions = [
            ...
            { condition: hasPermission('requests:status:pending-approval'), action: () => actions.openStatusDialog(request, 'pending-approval'), label: 'Enviar a Aprobación', icon: <ShoppingBag className="mr-2"/>, className: 'text-orange-600' },

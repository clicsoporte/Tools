...
export default function PurchaseRequestPage() {
    ...
    const {
        isSubmitting, isNewRequestDialogOpen, activeRequests, archivedRequests, viewingArchived,
        ...
        isReopenDialogOpen, reopenStep, reopenConfirmationText, companyData
    } = state;

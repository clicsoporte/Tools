            ...
            <Card key={type} className="flex flex-col">
                <CardHeader>
                    ...
                    <Input 
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleCompanyDataChange(fieldName, e.target.value)} 
                    />
                </CardHeader>
                <CardFooter>
                                ...
                                <div className="space-y-4">
                                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            ...
                                            <Input id="sql-host" value={sqlConfig.host || ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSqlConfigChange('host', e.target.value)} />
                                        </div>
                                        <div className="space-y-2">
                                            <Label htmlFor="sql-port">Puerto</Label>
                                            <Input id="sql-port" type="number" value={sqlConfig.port || ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSqlConfigChange('port', e.target.value)} />
                                        </div>
                                         <div className="space-y-2">
                                            <Label htmlFor="sql-database">Nombre de Base de Datos</Label>
                                            <Input id="sql-database" value={sqlConfig.database || ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSqlConfigChange('database', e.target.value)} />
                                        </div>
                                         <div className="space-y-2">
                                            <Label htmlFor="sql-user">Usuario</Label>
                                            <Input id="sql-user" value={sqlConfig.user || ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSqlConfigChange('user', e.target.value)} />
                                        </div>
                                         <div className="space-y-2">
                                            <Label htmlFor="sql-password">Contraseña</Label>
                                            <Input id="sql-password" type="password" value={sqlConfig.password || ''} onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleSqlConfigChange('password', e.target.value)} />
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-6">
                                    ...
                                    {importTypes.map(type => (
                                        <div key={type} className="space-y-2">
                                            ...
                                            <Textarea
                                                ...
                                                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => handleQueryChange(type, e.target.value)}
